        ...
        */
        ...
        register_default_headers(array(
            'wheel' => array(
                ...
                'description' => __('Wheel', "Untitled")
            ),
            'shore' => array(
                'url' => '%s/images/headers/shore.jpg',
                'thumbnail_url' => '%s/images/headers/shore-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Shore', "Untitled")
            ),
            'trolley' => array(
                'url' => '%s/images/headers/trolley.jpg',
                'thumbnail_url' => '%s/images/headers/trolley-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Trolley', "Untitled")
            ),
            'pine-cone' => array(
                'url' => '%s/images/headers/pine-cone.jpg',
                'thumbnail_url' => '%s/images/headers/pine-cone-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Pine Cone', "Untitled")
            ),
            'chessboard' => array(
                'url' => '%s/images/headers/chessboard.jpg',
                'thumbnail_url' => '%s/images/headers/chessboard-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Chessboard', "Untitled")
            ),
            'lanterns' => array(
                'url' => '%s/images/headers/lanterns.jpg',
                'thumbnail_url' => '%s/images/headers/lanterns-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Lanterns', "Untitled")
            ),
            'willow' => array(
                'url' => '%s/images/headers/willow.jpg',
                'thumbnail_url' => '%s/images/headers/willow-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Willow', "Untitled")
            ),
            'hanoi' => array(
                'url' => '%s/images/headers/hanoi.jpg',
                'thumbnail_url' => '%s/images/headers/hanoi-thumbnail.jpg',
                /* translators: header image description */
                'description' => __('Hanoi Plant', "Untitled")
            )
        ));        
    }
...
global $post, $product;
	...
	$label = '<span class="label label-primary sale">' . __( 'Sale!', "Untitled") .'</span>';
	return $label;    
	}; 
...
if (file_exists($fileName) && (isset($_POST['importt']) && isset($_POST['formdata']))) {
	...
	if( $imported ) {
		 $msg = __( "Content Imported successfully.", "Untitled" ) ;
         echo $msg; 
        $imported = false; 
	}
	else {
		 $msg = __( "Content Not Imported Sucessfully, import it again", "Untitled") ;
            echo $msg;
            $imported = false; 
	}
	wp_die();    
...
function TemplateToaster_continue_reading_link()
{
    if (TemplateToaster_theme_option('ttr_read_more_button')) {
        return '<br/><br/><a href="' . esc_url(get_permalink()) . '">' . '<span class="btn btn-default">' .__( TemplateToaster_theme_option('ttr_read_more'), '', "Untitled") . '<span class="meta-nav">&rarr;</span></span>'. '</a>';
    } else {
        return '<br/><br/><a href="' . esc_url(get_permalink()) . '">' . __(TemplateToaster_theme_option('ttr_read_more'), '', "Untitled") . '<span class="meta-nav">&rarr;</span></a>';
...
<?php echo(__('Navigation', "Untitled")); ?>
</h3>
<?php endif; ?>
<?php
            if ( ($nav_id == 'nav-above' && TemplateToaster_theme_option('ttr_pagination_link_posts_above')) || ($nav_id == 'nav-below' && TemplateToaster_theme_option('ttr_pagination_link_posts_below')) ){
                ...
                $pge = paginate_links(array(
                    ...
                    'prev_next' => True,
                    'format' => '?paged=%#%',
                    'prev_text' => __('Previous', "Untitled"),
                    'next_text' => __('Next', "Untitled"),
...
<?php next_posts_link(__('<span class="meta-nav">&larr;</span> Older posts', "Untitled")); ?>
</div>
  <div
      class="nav-next">
<?php previous_posts_link(__('Newer posts <span class="meta-nav">&rarr;</span>', "Untitled")); ?>
</div>
<?php } ?>
</nav>
<!-- #nav-above -->
...
<li class="post pingback">
  <p>
<?php _e('Pingback:', "Untitled"); ?>
<?php comment_author_link(); ?>
<?php edit_comment_link(__('Edit', "Untitled"), '<span class="edit-link">', '</span>'); ?>
</p>
<?php
    break;
    default :
...
<?php
        ...
        /* translators: 1: comment author, 2: date and time */
                            printf(__('%1$s on %2$s <span class="says">said:</span>', "Untitled"),
                                sprintf('<span class="fn">%s</span>', get_comment_author_link()),
                                sprintf('<a href="%1$s"><time datetime="%2$s">%3$s</time></a>',
                                    esc_url(get_comment_link($comment->comment_ID)),
                                    get_comment_time('c'),
                /* translators: 1: date, 2: time */
                                    sprintf(__('%1$s at %2$s', "Untitled"), get_comment_date(), get_comment_time())
            )
        );
        ?>
<?php edit_comment_link(__('Edit', "Untitled"), '<span class="edit-link">', '</span>'); ?>
...
<?php _e('Your comment is awaiting moderation.', "Untitled"); ?>
</em>
<br/>
<?php endif; ?>
<!--
...
<?php comment_text(); ?>
    ...
    <div class="reply">
<?php comment_reply_link(array_merge($args, array('reply_text' => __('Reply <span>&darr;</span>', "Untitled"), 'depth' => $depth, 'max_depth' => $args['max_depth']))); ?>
    </div>
    <!-- .reply -->
  </div>
  <!-- #comment-## -->
...
if (!function_exists('TemplateToaster_entry_meta')) :
    ...
    function TemplateToaster_entry_meta()
    {
        if (is_sticky() && is_home() && !is_paged())
            echo '<span class="featured-post">' . __('Sticky', "Untitled") . '</span>';
...
if (!function_exists('TemplateToaster_entry_date')) :
    ...
    {
        if (has_post_format(array('chat', 'status')))
            $format_prefix = _x('%1$s on %2$s ', '1: post format name. 2: date', "Untitled");
        else
            $format_prefix = '%2$s ';
        ...
        if (TemplateToaster_theme_option('ttr_remove_date')):
            $date = sprintf('<span class="date"><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s">%4$s</time></a></span>',
                ...
                esc_attr(sprintf(__('Permalink to %s', "Untitled"), the_title_attribute('echo=0'))),
    ...
    function TemplateToaster_posted_on($date, $author)
    {
        ...
        $post_url =  urldecode(esc_url( get_permalink() ) );
            ...
            if (is_sticky() && is_home() && !is_paged()) {
                ...
                echo '<span style="clear:both;">' . __('Sticky', "Untitled") . '</span>';
            }
            if ( get_the_time() !== get_the_modified_time() ) 
			{
				if ($date && $author)
				{
					...
					{
						$time_string = '<a href="' . $post_url . '" rel="bookmark"><img alt="' . __('date', "Untitled") . '" src="' . get_template_directory_uri() . '/images/datebutton.png"/><time class="updated" datetime="%3$s">%4$s</time><time class="entry-date post_updated published hidden d-none" datetime="%1$s">%2$s</time></a><span class = "meta">  ' . __('by ', "Untitled") . ' </span><span class="author vcard">  <img alt="' . __('author ', "Untitled") . '" src="' . get_template_directory_uri() . '/images/authorbutton.png"/>  <a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					   $post_status= __('Updated on ', "Untitled");
					}
					else if ($var_author)
					{
					  $time_string = '<span class = "meta">  ' . __('by ', "Untitled") . ' </span><span class="author vcard">  <img alt="' . __('author ', "Untitled") . '" src="' . get_template_directory_uri() . '/images/authorbutton.png"/>  <a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					}
					else if ($var_date)
					{
					   $time_string = '<img alt="' . __('date', "Untitled") . '" src="' . get_template_directory_uri() . '/images/datebutton.png"/><time class="updated" datetime="%3$s">%4$s</time><time class="entry-date post_updated published hidden d-none" datetime="%1$s">%2$s</time>';
					  $post_status= __('Updated on ', "Untitled");
					}
				}
				else if ($date && !$author) 
				{
					if ($var_date && $var_author)
					{
						$time_string = '<a href="' . $post_url . '" rel="bookmark"><img alt="' . __('date', "Untitled") . '" src="' . get_template_directory_uri() . '/images/datebutton.png"/><time class="updated" datetime="%3$s">%4$s</time><time class="entry-date post_updated published hidden d-none" datetime="%1$s">%2$s</time></a><span class = "meta">  ' . __('by ', "Untitled") . ' </span><span class="author vcard"> <a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					   $post_status= __('Updated on ', "Untitled");
					}
					else if ($var_author)
					{
					  $time_string = '<span class = "meta">  ' . __('by ', "Untitled") . ' </span><span class="author vcard"><a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					}
					else if ($var_date)
					{
					   $time_string = '<img alt="' . __('date', "Untitled") . '" src="' . get_template_directory_uri() . '/images/datebutton.png"/><time class="updated" datetime="%3$s">%4$s</time><time class="entry-date post_updated published hidden d-none" datetime="%1$s">%2$s</time>';
				...
				else
				{
					if ($var_date && $var_author)
					{
						$time_string = '<a href="' . $post_url . '" rel="bookmark"><time class="updated" datetime="%3$s">%4$s</time><time class="entry-date post_updated published hidden d-none" datetime="%1$s">%2$s</time></a><span class = "meta">  ' . __('by ', "Untitled") . ' </span><span class="author vcard"><a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					   $post_status= __('Updated on ', "Untitled");
					}
					else if ($var_author)
					{
			...
			else
			{
				if ($date && $author)
				{
					if ($var_date && $var_author)
					{
						$time_string='<a href="' . $post_url . '" rel="bookmark"><img alt="' . __('date', "Untitled") . '" src="' . get_template_directory_uri() . '/images/datebutton.png"/><time class="entry-date published" datetime="%1$s">%2$s</time><time class="post_published updated hidden d-none" datetime="%3$s">%4$s</time></a><span class = "meta">  ' . __('by ', "Untitled") . ' </span> <span class="author vcard"><img alt="' . __('author ', "Untitled") . '" src="' . get_template_directory_uri() . '/images/authorbutton.png"/>   <a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					$post_status=  __('Posted on ', "Untitled");
					}
					else if ($var_author)
					{
					  $time_string = '<span class = "meta">  ' . __('by ', "Untitled") . ' </span><span class="author vcard">  <img alt="' . __('author ', "Untitled") . '" src="' . get_template_directory_uri() . '/images/authorbutton.png"/>  <a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					...
					{
					   $time_string='<img alt="' . __('date', "Untitled") . '" src="' . get_template_directory_uri() . '/images/datebutton.png"/><time class="entry-date published" datetime="%1$s">%2$s</time><time class="post_published updated hidden d-none" datetime="%3$s">%4$s</time>';
					$post_status=  __('Posted on ', "Untitled");
					}
				}
				else if ($date && !$author)
				{
					if ($var_date && $var_author)
					{
						$time_string='<a href="' . $post_url . '" rel="bookmark"><img alt="' . __('date', "Untitled") . '" src="' . get_template_directory_uri() . '/images/datebutton.png"/><time class="entry-date published" datetime="%1$s">%2$s</time><time class="post_published updated hidden d-none" datetime="%3$s">%4$s</time></a><span class = "meta">  ' . __('by ', "Untitled") . ' </span> <span class="author vcard"><a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					$post_status=  __('Posted on ', "Untitled");
					}
					else if ($var_author)
					{
				...
				elseif (!$date && $author)
				{
					if ($var_date && $var_author)
					{
						$time_string='<a href="' . $post_url . '" rel="bookmark"><time class="entry-date published" datetime="%1$s">%2$s</time><time class="post_published updated hidden d-none" datetime="%3$s">%4$s</time></a><span class = "meta">  ' . __('by ', "Untitled") . ' </span> <span class="author vcard"><img alt="' . __('author ', "Untitled") . '" src="' . get_template_directory_uri() . '/images/authorbutton.png"/>   <a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					$post_status=  __('Posted on ', "Untitled");
					}
					else if ($var_author)
					{
				...
				else
				{
					if ($var_date && $var_author)
					{
						$time_string='<a href="' . $post_url . '" rel="bookmark"><time class="entry-date published" datetime="%1$s">%2$s</time><time class="post_published updated hidden d-none" datetime="%3$s">%4$s</time></a><span class = "meta">  ' . __('by ', "Untitled") . ' </span> <span class="author vcard"><a href="%5$s" title="%6$s" class="url fn n" rel="author">%7$s</a></span>';
					$post_status=  __('Posted on ', "Untitled");
					}
					else if ($var_author)
					{
			...
			$time_string = sprintf( $time_string,
					...
					esc_url(get_author_posts_url(get_the_author_meta('ID'))),
					sprintf(esc_attr__('View all posts by %s', "Untitled"), esc_html(get_the_author())),
					esc_html(get_the_author())
					);
					
					
			// Wrap the time string in a link, and preface it with 'Posted on' or 'Updated On'.
			printf(__( '<span class="meta">%s</span>%s', 'Untitled' ),$post_status,$time_string );
...
/* function TemplateToaster_generate_menu( $meenu, $TemplateToaster_magmenu, $TemplateToaster_menuh, $TemplateToaster_vmenuh, $TemplateToaster_ocmenu, $TemplateToaster_cssprefix = "ttr_")
{
    ...
    $output = '';
    if (is_front_page()) {
        $output .= '<li class="' . $TemplateToaster_cssprefix . $meenu . '_items_parent dropdown active"><a href="' . get_home_url(null, '/') . '" class="' . $TemplateToaster_cssprefix . $meenu . '_items_parent_link_active"><span class="menuchildicon"></span>' . __('Home', "Untitled");
	  ...
	  //  $output .= ('</a><hr class="horiz_separator" />'); 
        ...
        $output .= '<li class="' . $TemplateToaster_cssprefix . $meenu . '_items_parent dropdown"><a href="' . get_home_url(null, '/') . '" class="' . $TemplateToaster_cssprefix . $meenu . '_items_parent_link"><span class="menuchildicon"></span>' . __('Home', "Untitled");
...
function TemplateToaster_theme_comment_form($args = array(), $post_id = null)
{
    ...
    $fields = array(
        'author' => '<p class="comment-form-author">' . '<label for="author">' . __('Name', "Untitled") . '</label> ' . ($req ? '<span class="required">*</span>' : '') . '<br/>' .
            '<input id="author" name="author" type="text" value="' . esc_attr($commenter['comment_author']) . '" size="30"' . $aria_req . ' /></p>',
        'email' => '<p class="comment-form-email"><label for="email">' . __('Email', "Untitled") . '</label> ' . ($req ? '<span class="required">*</span>' : '') . '<br/>' .
            '<input id="email" name="email" type="text" value="' . esc_attr($commenter['comment_author_email']) . '" size="30"' . $aria_req . ' /></p>',
        'url' => '<p class="comment-form-url"><label for="url">' . __('Website', "Untitled") . '</label>' . '<br/>' .
            '<input id="url" name="url" type="text" value="' . esc_attr($commenter['comment_author_url']) . '" size="30" /></p>',
    );

    $required_text = sprintf(' ' . __('Required fields are marked %s', "Untitled"), '<span class="required">*</span>');
    $defaults = array(
        'fields' => apply_filters('comment_form_default_fields', $fields),
        'comment_field' => '<p class="comment-form-comment"><label for="comment">' . _x('Comment', 'noun', "Untitled") . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>' . '<br/>',
        'must_log_in' => '<p class="must-log-in">' . sprintf(__('You must be <a href="%s">logged in</a> to post a comment.', "Untitled"), wp_login_url(apply_filters('the_permalink', get_permalink($post_id)))) . '</p>',
        'logged_in_as' => '<p class="logged-in-as">' . sprintf(__('Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>', "Untitled"), admin_url('profile.php'), $user_identity, wp_logout_url(apply_filters('the_permalink', get_permalink($post_id)))) . '</p>',
        'comment_notes_before' => '<p class="comment-notes">' . __('Your email address will not be published.', "Untitled") . ($req ? $required_text : '') . '</p>',
        'comment_notes_after' => '<p class="form-allowed-tags">' . sprintf(__('You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s', "Untitled"), ' <code>' . allowed_tags() . '</code>') . '</p>',
        'id_form' => 'commentform',
        'id_submit' => 'submit',
        'title_reply' => __('Leave a Reply', "Untitled"),
        'title_reply_to' => __('Leave a Reply to %s', "Untitled"),
        'cancel_reply_link' => __('Cancel reply', "Untitled"),
        'label_submit' => __('Post Comment', "Untitled"),
    );
...
function TemplateToaster_add_init()
{
    ...
    if ($screen->id == 'appearance_page_mytheme-options') {
        ...
        $tt_upload_data = array('title' => __('Choose or Upload an Image', "Untitled"), 'text' => __('Use this image', "Untitled"));
...
function TemplateToaster_replace_thickbox_text($translated_text, $text, $domain)
{
    if ('Insert into Post' == $text) {
        ...
        if ($referer != '') {
            return __('Select this image!', "Untitled");
        }
    }
...
function TemplateToaster_customAdmin()
{
    ...
    $passed_data = array('on' => __('ON', "Untitled"), 'off' => __('OFF', "Untitled"), 'pageClass' => $pageClass);
        }
        else
	  $passed_data = array('on' => __('ON', "Untitled"), 'off' => __('OFF', "Untitled"));
   ...
   // wp_enqueue_script('jquery_tinymce_script');
	...
	if ($islisticon) {
		echo '{list-style-image:url('. get_stylesheet_directory_uri() . '/images/1974126963listimg.png);}';
	} else {
...
function TemplateToaster_wordpress_breadcrumbs()
    ...
    $name = __('Home', "Untitled"); //text for the 'Home' link
    ...
    if (!is_home() && !is_front_page() || is_paged()) {
        ...
        if (is_category()) {
            ...
            echo $currentBefore . __('Archive by category &#39;', "Untitled");
            single_cat_title();
            echo '&#39;' . $currentAfter;
            ...
            echo $currentBefore . __('Search results for &#39;', "Untitled") . get_search_query() . '&#39;' . $currentAfter;

        } elseif (is_tag()) {
            echo $currentBefore . __('Posts tagged &#39;', "Untitled");
            single_tag_title();
            echo '&#39;' . $currentAfter;
            ...
            echo $currentBefore . __('Articles posted by', "Untitled") . $userdata->display_name . $currentAfter;

        } elseif (is_404()) {
            echo $currentBefore . __('Error 404', "Untitled") . $currentAfter;
		}

        if (get_query_var('paged')) {
            if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author()) echo ' (';
            echo __('Page', "Untitled") . ' ' . get_query_var('paged');
            if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author()) echo ')';
        }
...
function TemplateToaster_in_widget_form($t, $return, $instance)
{
    ...
    $wp_page_types = array(
        'front' => __('Front', "Untitled"),
        'home' => __('Blog', "Untitled"),
        'archive' => __('Archives', "Untitled"),
        'single' => __('Single Post', "Untitled"),
        '404' => __('404', "Untitled")
    );
...
<br/>
<label>
<?php echo(__('Hide widget on:', "Untitled")); ?>
</label>
...
<div class="menupageelement">
        ...
        <label class="widgetlabel"
          ...
          "><?php echo $label . ' ' . __('Page', "Untitled") ?>
</label>
        </div>
<?php } ?>
</div>
...
<?php if (!isset($instance['style']))
        $instance['style'] = null;
	?>
<label for="<?php echo $t->get_field_id('style'); ?>"><?php echo(__('Block Style:', "Untitled")); ?>
</label>
  <select id="<?php echo $t->get_field_id('style'); ?>" name="<?php echo $t->get_field_name('style'); ?>">
    <option
      <?php selected($instance['style'], 'default'); ?>value="default"><?php echo(__('Default', "Untitled")); ?>
</option>
    <option
      <?php selected($instance['style'], 'none'); ?>
      value="none"><?php echo(__('None', "Untitled")); ?>
</option>
    <option
      <?php selected($instance['style'], 'block'); ?>value="block"><?php echo(__('Block', "Untitled")); ?>
</option>
        </select>
<?php
    $retrun = null;
...
<span class="url"><a class="<?php echo $TemplateToaster_cssprefix; ?>author_name" href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ) ?>"></a><?php
    echo get_comment_author_link( $comment->comment_ID ); ?>
                ...
                <time datetime="<?php echo get_comment_date("c")?>" class="comment-date">
                    <a class="<?php echo $TemplateToaster_cssprefix; ?>comment_date" href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf(__('%1$s at %2$s', "Untitled"), get_comment_date(),  get_comment_time()) ?></a> </time>
                <hr style="color:#fff;"/>
<?php comment_text() ?>
<div style="clear:both"></div>
                <hr style="color:#fff;">
                ...
                <div class="<?php echo $TemplateToaster_cssprefix; ?>comment_reply_edit">
                    ...
                    <span class="<?php echo $TemplateToaster_cssprefix; ?>reply_edit"><?php edit_comment_link(__('(Edit)', "Untitled")) ?></span>
                </div>
<?php if ($comment->comment_approved == '0') : ?>
<br /><em><?php _e('Your comment is awaiting approval.', "Untitled") ?></em>
<?php endif; ?>
</div>
...
function theme_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'colorscheme', array(
		'type'    => 'radio',
		'label'    => __( 'Color Scheme', 'Untitled' ),
		'choices'  => array(
			'light'  => __( 'Light', 'Untitled' ),
			'custom' => __( 'Custom', 'Untitled' ),
		),
		'section'  => 'colors',
		'priority' => 5,
	) );
...
function templatetoaster_import_xml()
{
	...
	if ($_POST['data'] != NULL)
	{
		...
		$load_theme_options=simplexml_load_string($LoadXML1) or die(__('Error: Cannot create object','Untitled'));
		...
		if ($load_theme_options->option)
		{
			...
			if($result)
			{
				die(__('Theme options imported successfully','Untitled'));				
			}
			else
			{
				die(__('Problem in importing theme options.','Untitled'));	
			}
		}
		else
		{
			die(__('Incorrect XML file.','Untitled'));
		}	
	}
	else
	{
		die(__('Please, upload an XML file only','Untitled'));
	}
}
