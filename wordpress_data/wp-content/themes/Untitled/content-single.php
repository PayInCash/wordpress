...
<?php wp_link_pages( array( 'before' => '<div class="page-link"><span>' . __( 'Pages:', 'Untitled' ) . '</span>', 'after' => '</div>' ) ); ?>
<div class="postedon">
<?php
...
$utility_text = __( 'This entry was posted in %1$s and tagged %2$s by <a href="%6$s">%5$s</a>. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'Untitled' );
}
else{$utility_text = __( 'Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'Untitled' );
}
}
elseif ( '' != $categories_list ) {
if(TemplateToaster_theme_option('ttr_remove_post_category'))
{
$utility_text = __( 'This entry was posted in %1$s by <a href="%6$s">%5$s</a>. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'Untitled' );
} else {
$utility_text = __( 'Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'Untitled' );
}
}
else{
if(TemplateToaster_theme_option('ttr_remove_post_category')){
...
<h2><?php printf( esc_attr__( 'About %s', 'Untitled' ), get_the_author() ); ?></h2>
<?php the_author_meta( 'description' ); ?>
<div id="author-link">
<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
<?php printf( __( 'View all posts by %s <span class="meta-nav">&rarr;</span>', 'Untitled' ), get_the_author() ); ?>
</a>
</div>
</div>
</div>
