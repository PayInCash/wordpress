...
class TemplateToaster_Theme_Options extends TemplateToaster_Theme_Options_Dynamic
{
    ...
    public function __construct()
    {
        ...
        $this->sections['error'] = __('Error Page', "Untitled");
        $this->sections['maintenance'] = __('Maintenance', "Untitled");
        $this->sections['shortcodes'] = __('Shortcode', "Untitled");
        $this->sections['googlemap'] = __('GoogleMap', "Untitled");
        //$this->sections['contactus'] = __('Contact Us', "Untitled");
		// $this->sections['seo'] = __('SEO', "Untitled");
        $this->sections['backuppage'] = __('Backup/Recovery', "Untitled");
        $this->sections['export_import'] = __('Export/Import Theme Options', "Untitled");
        $fileName = get_template_directory() . '/content/imports.php';
		if ( file_exists( $fileName ) ) { 
        $this->sections['import_content'] = __('Import Content', "Untitled"); 
        }
    ...
    public function create_setting($args = array())
    {
        ...
        $defaults = array(
            'id' => 'default_field',
            'title' => __('Default Field', "Untitled"),
            'desc' => __('This is a default description.', "Untitled"),
            'std' => '',
            'type' => 'text',
            'section' => 'general',
            'choices' => array(),
    ...
    public function display_page()
    {
       ...
       //display URl error message 
        ...
        {
            echo '<div class="updated fade"><p>' . __('Theme options updated.', "Untitled") . '</p></div>';
		}
        echo '<div id="admin_container" class="wrap">
	            <div class="icon-option"> </div>
	            <h1>' . __('Theme Options For', "Untitled") . '&nbsp;' . $themename . '</h1><br/>';
		...
		echo '</div>';
		echo '<p class="submit">' .
            get_submit_button(__('Save Options', "Untitled"), 'button-primary', 'ttr_submit', false). '</p>';			
		echo '</form>';
        echo '</div>';
    }
       ...
       <div id="content">
                ...
                ?>
                    <table class="table">
                        <tbody>
                        <tr>
                            <td colspan="3"><?php echo(__("To use CONTACT FORM, apply shortcode [contact_us_form]","Untitled"));?></td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Admin Email Address',"Untitled"));?></td>
                            <td colspan="2">
                        ...
                        <!-- Google Captcha -->
                        <tr>
                            <td><?php echo(__('Public Key For Google Captcha',"Untitled"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Private Key For Google Captcha',"Untitled"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Error Message',"Untitled"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_error_message" <?php if($value_contact[3]['ttr_contact_us_error_message']){ ?> value="<?php print_r($value_contact[3]['ttr_contact_us_error_message']); ?>" <?php } else {?> value="<?php echo(__("Message was not sent. Try Again.","Untitled"));?>"<?php } ?> name="ttr_contact_us_error_message" />
                        ...
                        <tr>
                            <td><?php echo(__('Success Message',"Untitled"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_success_message" <?php if($value_contact[4]['ttr_contact_us_success_message']){ ?> value="<?php print_r($value_contact[4]['ttr_contact_us_success_message']); ?>" <?php } else {?> value="<?php echo(__("Thanks! Your message has been sent.","Untitled")); ?>"<?php } ?>  name="ttr_contact_us_success_message" />

                            </td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Field Name:',"Untitled"));?></td>
                           <!-- <td><?php echo(__('Field Type:',"Untitled"));?></td>-->
                            <td><?php echo(__('Required',"Untitled"));?></td>
                            <td><?php echo(__('Remove',"Untitled"));?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4"><input type="button" value="<?php echo(__('Add New Field',"Untitled"));?>" class="newfield button-secondary" /></td>
                        </tr>
...
<?php
  ...
  /*  public function display_seoenable_section()
    ...
    public function display_backuppage_section()
    {
        ...
        $this->sections['backupsettings'] = __('Settings', "Untitled");
        $this->sections['backup'] = __('Backup', "Untitled");
        $this->sections['restore'] = __('Restore', "Untitled");
	...
	?>
		<table class="form-table">
	    	<tbody>
	    		<tr>
		            <th>
		            <label><?php echo(__('Export theme options','Untitled'));?></label>
					</th><td>	            
	            	<input id="export_yes" class="button button-primary" type="button" name="exportt" value="<?php echo(__('Export Theme Option','Untitled'));?>" />	            	
	                </td>
	            </tr>
	            <tr>
	               <th>	               
	                <label id="select_file"><?php echo(__('Import theme options? ','Untitled'));?></label>
	                </th><td>
			       	<input type="file" name="importfile" id="importfile" style="height:auto;">
			       	<input id="import_options_yes" class="button button-primary" type="button" value="<?php echo(__('Import Theme Options','Untitled'));?>" name="import_options">			       
	                </td>
	            </tr>
			</tbody>
	    </table>
       ...
       if (!get_option('TemplateToaster_theme_options'))
        ...
        switch ($type) {
            ...
            case 'media':
                ...
                echo '&nbsp;<input type="button" class="ttrbutton btn" value="' . __('Upload', "Untitled") . '"/>';
                if ($desc != '')
                    echo '<br /><span class="description">' . $desc . '</span>';
    ...
    public function get_static_options()
    {
       ...
       /* Error page Settings
        ...
        $this->settings['ttr_error_message_heading'] = array(
            'title' => __('Heading For Error Message', "Untitled"),
            'desc' => __('Change Text For Error Message', "Untitled"),
            'std' => __('This is somewhat embarrassing, isn&rsquo;t it?', "Untitled"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message_content'] = array(
            'title' => __('Content For Error Message', "Untitled"),
            'desc' => __('Change text For Error Message', "Untitled"),
            'std' => __('It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching, or one of the links below, can help.', "Untitled"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message'] = array(
            'title' => __('Enable Content', "Untitled"),
            'desc' => __('Hide/Show Error Message Text', "Untitled"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_search_box'] = array(
            'title' => __('Enable Search', "Untitled"),
            'desc' => __('Hide/Show Search Box', "Untitled"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image'] = array(
            'title' => __('Content Image', "Untitled"),
            'desc' => __('Choose Error Image', "Untitled"),
            'std' => '',
            'type' => 'media',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_enable'] = array(
            'title' => __('Enable Image In Content', "Untitled"),
            'desc' => __('Hide/Show error image', "Untitled"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_height'] = array(
            'title' => __('Content Image Height', "Untitled"),
            'desc' => __('Height Of The Error Image', "Untitled"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_image_width'] = array(
            'title' => __('Content Image Width', "Untitled"),
            'desc' => __('Width of The Error Image', "Untitled"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_home_redirect'] = array(
            'title' => __('Redirect To Home Page(If Error Page Occurs)', "Untitled"),
            'desc' => __('Redirect to Home Page While Error Occur', "Untitled"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        ...
        $this->settings['ttr_mm_enable'] = array(
            'title' => __('Enable Maintenance Mode', "Untitled"),
            'desc' => __('Enable/Disable Maintenance Mode', "Untitled"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_title'] = array(
            'title' => __('Title for Maintenance Mode Page', "Untitled"),
            'desc' => __('Set the Title', "Untitled"),
            'std' => '',
            'type' => 'text',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_content'] = array(
            'title' => __('Content for Maintenance Mode Page', "Untitled"),
            'desc' => __('Content for Maintenance Mode page', "Untitled"),
            'std' => '',
            'type' => 'textarea',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_image'] = array(
            'title' => __('Background Image for Maintenance Mode', "Untitled"),
            'desc' => __('Select Image for Maintenance Mode Page', "Untitled"),
            'std' => '',
            'type' => 'media',
            'section' => 'maintenance'
        );
        ...
        $this->settings['ttr_googlemap_type'] = array(
            'title' => __('Choose the type of Google Map', "Untitled"),
            'desc' => __('Choose the type of Google Map', "Untitled"),
            'type' => 'select',
            'std' => 'Road',
            'choices' => array(
                'choice1' => __('ROAD', "Untitled"),
                'choice2' => __('SATELLITE', "Untitled"),
                'choice3' => __('HYBRID', "Untitled"),
                'choice4' => __('TERRAIN', "Untitled")),
            'section' => 'googlemap'
        );
       $this->settings['ttr_map_latitude'] = array(
            'title' => __('Set Latitude', "Untitled"),
            'desc' => __('Set Latitude', "Untitled"),
            'std' => '25.306944',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_longitude'] = array(
            'title' => __('Set Longitude', "Untitled"),
            'desc' => __('Set Longitude', "Untitled"),
            'std' => '-257.858333',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_width'] = array(
            'title' => __('Set Width of Map', "Untitled"),
            'desc' => __('Set Width of Map', "Untitled"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_height'] = array(
            'title' => __('Set Height of Map', "Untitled"),
            'desc' => __('Set Height of Map', "Untitled"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_marker_enable'] = array(
            'title' => __('Display Marker', "Untitled"),
            'desc' => __('Enable/Disable the Position Marker', "Untitled"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'googlemap'
        );
        $this->settings['ttr_marker_text'] = array(
            'title' => __('Set Marker Label', "Untitled"),
            'desc' => __('Set Marker Label', "Untitled"),
        ...
        $this->settings['ttr_googlemap_api'] = array(
            'title' => __('Set Google API Key', "Untitled"),
            'desc' => __('Set Google API Key', "Untitled"),
            'std' => '',
            'type' => 'text',
            'patter' => '\d+',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_google_docs_viewer_shortcode'] = array(
            'title' => __('Google Docs Viewer', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_displaying_recent_posts_shortcode'] = array(
            'title' => __('Displaying Related Posts', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
            'std' => '[related_posts]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_google_adsense_shortcode'] = array(
            'title' => __('Google AdSense', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_google_chart_shortcode'] = array(
            'title' => __('Google Chart', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_tweet_me_button_shortcode'] = array(
            'title' => __('Tweet Me Button', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
            'std' => '[tweet]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_private_content_shortcode'] = array(
            'title' => __('Private Content', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
        ...
        /*$this->settings['ttr_contact_us_form_shortcode'] = array(
            'title' => __('Contact Us Form', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
            'std' => '[contact_us_form]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_recent_comments_shortcode'] = array(
            'title' => __('Recent Comments', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_posts_shortcode'] = array(
            'title' => __('Recent Posts', "Untitled"),
            'desc' => __('To use Copy/Paste the above shortcode', "Untitled"),
            'type' => 'shortcode',
       ...
       ===========================================*/
        ...
        $this->settings['ttr_ftp_server_address'] = array(
            'title' => __('FTP Server Address', "Untitled"),
            'desc' => __('Enter the FTP Address ', "Untitled"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_name'] = array(
            'title' => __('FTP User name', "Untitled"),
            'desc' => __('Enter the FTP username ', "Untitled"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_password'] = array(
            'title' => __('FTP User password', "Untitled"),
            'desc' => __('Enter the FTP password ', "Untitled"),
            'std' => '',
            'type' => 'password',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_recipient_email'] = array(
            'title' => __('Email of recipient', "Untitled"),
            'desc' => __('Enter the name of email recipient ', "Untitled"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_check_connection'] = array(
            'title' => __('Check FTP Connection', "Untitled"),
            'desc' => __('Click to check the FTP Connection Status', "Untitled"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_manual_database_backup'] = array(
            'title' => __('Database Backup (.sql file)', "Untitled"),
            'desc' => __('Add/Remove database (.sql) file to Backup zip', "Untitled"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_recovery_enable'] = array(
            'title' => __('Enable Automatic Backup/Recovery Mode)', "Untitled"),
            'desc' => __('Enable/Disable Automatic Backup/Recovery Mode', "Untitled"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_plugin_backup'] = array(
            'title' => __('Include Plugins', "Untitled"),
            'desc' => __('Include/Exclude plugins to Backup Zip', "Untitled"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_theme_backup'] = array(
            'title' => __('Include Themes', "Untitled"),
            'desc' => __('Include/Exclude themes to Backup Zip', "Untitled"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_uploads_backup'] = array(
            'title' => __('Include Uploads', "Untitled"),
            'desc' => __('Include/Exclude uploads to Backup Zip', "Untitled"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "Untitled"),
            'desc' => __('Set the folder name to take the backup', "Untitled"),
            'std' => 'Backup',
            'type' => 'text',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_interval'] = array(
            'title' => __('Automatic Backup intervals', "Untitled"),
            'desc' => __('Select the database interval to take backup', "Untitled"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('Every 10 mins', "Untitled"),
                'choice2' => __('Every hour', "Untitled"),
                'choice3' => __('Every 4 hours', "Untitled"),
                'choice4' => __('Every 8 hours', "Untitled"),
                'choice2' => __('Every 12 hours', "Untitled"),
                'choice3' => __('Daily', "Untitled"),
                'choice4' => __('Weekly', "Untitled")),
            'section' => 'backup'
        );
        $this->settings['ttr_storage_backup'] = array(
            'title' => __('Choose your Remote Storage', "Untitled"),
            'desc' => __('Set time to the backup', "Untitled"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('FTP', "Untitled"),
                'choice2' => __('Email', "Untitled")),
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "Untitled"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_browse'] = array(
            'title' => __('Select Backup Folder', "Untitled"),
            'desc' => __('Select the folder(.zip file only)', "Untitled"),
            'std' => '',
            'type' => 'file',
            'section' => 'restore'
        );
        $this->settings['ttr_include_database_restore'] = array(
            'title' => __('Restore Database(.sql)', "Untitled"),
            'desc' => __('Enable/Disable to restore databases for Site', "Untitled"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_theme_restore'] = array(
            'title' => __('Restore Themes', "Untitled"),
            'desc' => __('Enable/Disable to restore theme folder for Site', "Untitled"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_plugins_restore'] = array(
            'title' => __('Restore Plugins', "Untitled"),
            'desc' => __('Enable/Disable to restore plugins folder for Site', "Untitled"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_uploads_restore'] = array(
            'title' => __('Restore Uploads', "Untitled"),
            'desc' => __('Enable/Disable to restore uploads folder for Site', "Untitled"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
    ...
    public function scripts()
    {
        ...
        $translations = array_merge(array('tt_xmlerror' => (__('Please, select an xml file','Untitled')), 'tt_savechanges' => (__('No changes to export in Theme Options. Please save your changes properly.','Untitled'))));
    ...
    public function validate_settings($input)
    {
        ...
        foreach ($this->settings as  $key => $value)
        {
 			if($key == 'ttr_designedby_link_url')
            {
               ...
               { 
                 add_settings_error('templatetoaster_theme_options','errorMsg',__("Please enter a valid URL", "Untitled"),'error') ;
			     return $options;
              }             
            }
