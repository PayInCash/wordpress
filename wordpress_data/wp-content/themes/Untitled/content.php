...
<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', CURRENT_THEME, 'Untitled' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php endif; ?><?php the_title(); ?></a>
<?php  } else {
...
<?php $postid = ( isset( $post->ID ) ? get_the_ID() : NULL );
if(get_post_meta($postid,'ttr_post_link_enable_checkbox',true)!= 'false'):?>
<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'Untitled' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php endif; ?><?php the_title(); ?></a>
<?php echo "</$post_tag>"; } ?>
</div>
<?php endif; ?>
...
<?php endif;?>
<?php wp_link_pages( array( 'before' => '<span>' . __( 'Pages:', 'Untitled' ) . '</span>', 'after' => '' ) ); ?>
<?php $show_sep = false; ?>
<div class="postedon">
...
if ( $categories_list ):
?>
<?php printf( __( '<span class="meta">Posted in </span> %2$s', 'Untitled' ), '', $categories_list );
$show_sep = true; ?>
<?php endif; ?>
<?php
$tags_list = get_the_tag_list( '', __( ', ', 'Untitled' ) );
if ( $tags_list ):
if ( $show_sep ) : ?>
<span class="meta-sep"> | </span>
<?php endif; ?>
<?php printf( __( 'Tagged %2$s', 'Untitled' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list );
$show_sep = true; ?>
<?php endif; ?>
<?php endif;  ?>
<?php endif;  ?>
...
<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a reply', 'Untitled' ) . '</span>', __( '<b>1</b> Reply', 'Untitled' ), __( '<b>%</b> Replies', 'Untitled' ) ); ?>
<?php endif; ?>
