...
<h1>
<?php if ( is_day() ) : ?>
<?php printf( __( 'Daily Archives: %s', 'Untitled' ), '<span>' . get_the_date() . '</span>' ); ?>
<?php elseif ( is_month() ) : ?>
<?php printf( __( 'Monthly Archives: %s', 'Untitled' ), '<span>' . get_the_date( 'F Y' ) . '</span>' ); ?>
<?php elseif ( is_year() ) : ?>
<?php printf( __( 'Yearly Archives: %s', 'Untitled' ), '<span>' . get_the_date( 'Y' ) . '</span>' ); ?>
<?php else : ?>
<?php _e( 'Blog Archives', 'Untitled' ); ?>
<?php endif; ?>
</h1>
...
<?php _e( 'Nothing Found', 'Untitled' ); ?></h2>
<div class="postcontent entry-content">
<p><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'Untitled' ); ?></p>
<?php get_search_form(); ?>
