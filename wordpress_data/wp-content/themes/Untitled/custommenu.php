...
class TemplateToaster_custom_Menu extends WP_Widget {
    ...
    // setting the widget
        $widget_ops = array( 'description' => __('Use this widget to add one of your custom menus as a widget.',"Untitled") );
        parent::__construct( 'nav_menu', __('Custom Menu',"Untitled"), $widget_ops );
    }
    ...
    function form( $instance) {//form of the widget
        ...
        if ( !$menus ) {
            echo '<p>'. sprintf( __('No menus have been created yet. <a href="%s">Create some</a>.',"Untitled"), admin_url('nav-menus.php') ) .'</p>';
            return;
        }

        ?>
        <p>
          <label for ="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', "Untitled") ?></label>
          <input type="text" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $title; ?>"/>
        </p>

        <p>
          <label for ="<?php echo $this->get_field_id('nav_menu'); ?>"><?php _e('Select Menu:', "Untitled"); ?></label>
        ...
        <div class="menuoptions">
            ...
            <label for="<?php echo $this->get_field_id('alignment'); ?>"><?php echo(__('Menu Display:',"Untitled"));?>
            </label>
            <select class ="fullwidth" onchange="color_display(this);" id="<?php echo $this->get_field_id('alignment'); ?>" name="<?php echo $this->get_field_name('alignment'); ?>">
                <option <?php selected($instance['alignment'], 'nostyle');?> value="nostyle"><?php _e('No Style',"Untitled"); ?>
                </option>
                <option <?php selected($instance['alignment'], 'default');?>value="default"><?php _e('TT Default',"Untitled"); ?>
                </option>
            </select>
            <br />
            <?php if($instance['alignment']=='nostyle')
            { ?>
             <label class= "cmenu_style" for="<?php echo $this->get_field_id('menustyle'); ?>" style="display:none;"><?php echo(__('Menu Style:',"Untitled"));?>
            </label>
           ...
           <?php }
            ...
            { ?>
            <label class="cmenu_style" for="<?php echo $this->get_field_id('menustyle'); ?>"><?php echo(__('Menu Style:',"Untitled"));?>
            </label>
            <select class ="fullwidth cmenu_style" id="<?php echo $this->get_field_id('menustyle'); ?>" name="<?php echo $this->get_field_name('menustyle'); ?>">
          <?php } ?>
                <option <?php selected($instance['menustyle'], 'hmenu');?>value="hmenu"><?php _e('Horizontal Menu',"Untitled"); ?>
                </option>
                <option <?php selected($instance['menustyle'], 'vmenu');?>value="vmenu"><?php _e('Vertical Menu',"Untitled"); ?>
                </option>
            </select>
...
function TemplateToaster_style() {
    ...
    foreach((array) $wp_registered_sidebars as $index => $value)
    {
        ...
        foreach ( (array) $sidebars_widgets[$index] as $id ) {
            ...
            if($params[0]['widget_name']==__('Custom Menu',"Untitled")){
