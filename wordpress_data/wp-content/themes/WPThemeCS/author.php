...
?>
<h1>
<?php printf( __( 'Author Archives: %s', 'WPThemeCS' ), '<span><a href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?>
</h1>
<?php
rewind_posts();
?>
...
<div id="author-description">
	<h2><?php printf( __( 'About %s', 'WPThemeCS' ), get_the_author() ); ?></h2>
