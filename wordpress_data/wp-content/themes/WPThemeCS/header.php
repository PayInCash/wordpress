...
<img alt="<?php esc_attr_e('Back to Top', 'WPThemeCS'); ?>" src="<?php echo esc_url($gotopng); ?>">
</a>
<?php else : ?>
<a href="#" class="back-to-top">
<img alt="<?php esc_attr_e('Back to Top', 'WPThemeCS'); ?>" src="<?php echo esc_url(get_template_directory_uri()).'/images/gototop0.png';?>">
</a>
<?php endif; ?>
</div>
...
<span class="ttr_header_logo_text">JOE'S COFFEE SHOP</span>
</div>
</div>
</div>
</header>
...
<div class="html_content"><p style="line-height:2.71em;"><span style="font-size:1.857em;color:rgba(255,255,255,1);">WE PERFECTED COFFEE</span></p><p style="line-height:2.1em;"><span style="font-size:1.429em;color:rgba(255,255,255,1);">Visit us in store to see for yourself</span></p><p style="line-height:2.1em;"><span style="font-size:1.429em;color:rgba(255,255,255,1);">123 Street Avenue</span></p></div>
</div>
</div>
</li>
