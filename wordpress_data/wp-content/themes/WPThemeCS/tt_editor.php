...
<li role="presentation"><a data-toggle="tab" aria-controls="tt_editor_tab1" href="#tt_editor_tab1" role="tab" >' . __( 'Default Editor','WPThemeCS') . '</a></li>
<li class="active" role="presentation"><a data-toggle="tab" aria-controls="tt_editor_tab2" href="#tt_editor_tab2" role="tab">' . __( 'Custom Editor','WPThemeCS') . '</a></li>
</ul>';
