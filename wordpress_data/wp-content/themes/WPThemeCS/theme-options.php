...
class TemplateToaster_Theme_Options extends TemplateToaster_Theme_Options_Dynamic
{
    ...
    public function __construct()
    {
        ...
        $this->sections['error'] = __('Error Page', "WPThemeCS");
        $this->sections['maintenance'] = __('Maintenance', "WPThemeCS");
        $this->sections['shortcodes'] = __('Shortcode', "WPThemeCS");
        $this->sections['googlemap'] = __('GoogleMap', "WPThemeCS");
        //$this->sections['contactus'] = __('Contact Us', "WPThemeCS");
		// $this->sections['seo'] = __('SEO', "WPThemeCS");
        $this->sections['backuppage'] = __('Backup/Recovery', "WPThemeCS");
        $this->sections['export_import'] = __('Export/Import Theme Options', "WPThemeCS");
        $fileName = get_template_directory() . '/content/imports.php';
		if ( file_exists( $fileName ) ) { 
        $this->sections['import_content'] = __('Import Content', "WPThemeCS"); 
        }
    ...
    public function create_setting($args = array())
    {
        ...
        $defaults = array(
            'id' => 'default_field',
            'title' => __('Default Field', "WPThemeCS"),
            'desc' => __('This is a default description.', "WPThemeCS"),
            'std' => '',
            'type' => 'text',
            'section' => 'general',
            'choices' => array(),
    ...
    public function display_page()
    {
       ...
       //display URl error message 
        ...
        {
            echo '<div class="updated fade"><p>' . __('Theme options updated.', "WPThemeCS") . '</p></div>';
		}
        echo '<div id="admin_container" class="wrap">
	            <div class="icon-option"> </div>
	            <h1>' . __('Theme Options For', "WPThemeCS") . '&nbsp;' . $themename . '</h1><br/>';
		...
		echo '</div>';
		echo '<p class="submit">' .
            get_submit_button(__('Save Options', "WPThemeCS"), 'button-primary', 'ttr_submit', false). '</p>';			
		echo '</form>';
        echo '</div>';
    }
       ...
       <div id="content">
                ...
                ?>
                    <table class="table">
                        <tbody>
                        <tr>
                            <td colspan="3"><?php echo(__("To use CONTACT FORM, apply shortcode [contact_us_form]","WPThemeCS"));?></td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Admin Email Address',"WPThemeCS"));?></td>
                            <td colspan="2">
                        ...
                        <!-- Google Captcha -->
                        <tr>
                            <td><?php echo(__('Public Key For Google Captcha',"WPThemeCS"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Private Key For Google Captcha',"WPThemeCS"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Error Message',"WPThemeCS"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_error_message" <?php if($value_contact[3]['ttr_contact_us_error_message']){ ?> value="<?php print_r($value_contact[3]['ttr_contact_us_error_message']); ?>" <?php } else {?> value="<?php echo(__("Message was not sent. Try Again.","WPThemeCS"));?>"<?php } ?> name="ttr_contact_us_error_message" />
                        ...
                        <tr>
                            <td><?php echo(__('Success Message',"WPThemeCS"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_success_message" <?php if($value_contact[4]['ttr_contact_us_success_message']){ ?> value="<?php print_r($value_contact[4]['ttr_contact_us_success_message']); ?>" <?php } else {?> value="<?php echo(__("Thanks! Your message has been sent.","WPThemeCS")); ?>"<?php } ?>  name="ttr_contact_us_success_message" />

                            </td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Field Name:',"WPThemeCS"));?></td>
                           <!-- <td><?php echo(__('Field Type:',"WPThemeCS"));?></td>-->
                            <td><?php echo(__('Required',"WPThemeCS"));?></td>
                            <td><?php echo(__('Remove',"WPThemeCS"));?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4"><input type="button" value="<?php echo(__('Add New Field',"WPThemeCS"));?>" class="newfield button-secondary" /></td>
                        </tr>
...
<?php
  ...
  /*  public function display_seoenable_section()
    ...
    public function display_backuppage_section()
    {
        ...
        $this->sections['backupsettings'] = __('Settings', "WPThemeCS");
        $this->sections['backup'] = __('Backup', "WPThemeCS");
        $this->sections['restore'] = __('Restore', "WPThemeCS");
	...
	?>
		<table class="form-table">
	    	<tbody>
	    		<tr>
		            <th>
		            <label><?php echo(__('Export theme options','WPThemeCS'));?></label>
					</th><td>	            
	            	<input id="export_yes" class="button button-primary" type="button" name="exportt" value="<?php echo(__('Export Theme Option','WPThemeCS'));?>" />	            	
	                </td>
	            </tr>
	            <tr>
	               <th>	               
	                <label id="select_file"><?php echo(__('Import theme options? ','WPThemeCS'));?></label>
	                </th><td>
			       	<input type="file" name="importfile" id="importfile" style="height:auto;">
			       	<input id="import_options_yes" class="button button-primary" type="button" value="<?php echo(__('Import Theme Options','WPThemeCS'));?>" name="import_options">			       
	                </td>
	            </tr>
			</tbody>
	    </table>
       ...
       if (!get_option('TemplateToaster_theme_options'))
        ...
        switch ($type) {
            ...
            case 'media':
                ...
                echo '&nbsp;<input type="button" class="ttrbutton btn" value="' . __('Upload', "WPThemeCS") . '"/>';
                if ($desc != '')
                    echo '<br /><span class="description">' . $desc . '</span>';
    ...
    public function get_static_options()
    {
       ...
       /* Error page Settings
        ...
        $this->settings['ttr_error_message_heading'] = array(
            'title' => __('Heading For Error Message', "WPThemeCS"),
            'desc' => __('Change Text For Error Message', "WPThemeCS"),
            'std' => __('This is somewhat embarrassing, isn&rsquo;t it?', "WPThemeCS"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message_content'] = array(
            'title' => __('Content For Error Message', "WPThemeCS"),
            'desc' => __('Change text For Error Message', "WPThemeCS"),
            'std' => __('It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching, or one of the links below, can help.', "WPThemeCS"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message'] = array(
            'title' => __('Enable Content', "WPThemeCS"),
            'desc' => __('Hide/Show Error Message Text', "WPThemeCS"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_search_box'] = array(
            'title' => __('Enable Search', "WPThemeCS"),
            'desc' => __('Hide/Show Search Box', "WPThemeCS"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image'] = array(
            'title' => __('Content Image', "WPThemeCS"),
            'desc' => __('Choose Error Image', "WPThemeCS"),
            'std' => '',
            'type' => 'media',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_enable'] = array(
            'title' => __('Enable Image In Content', "WPThemeCS"),
            'desc' => __('Hide/Show error image', "WPThemeCS"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_height'] = array(
            'title' => __('Content Image Height', "WPThemeCS"),
            'desc' => __('Height Of The Error Image', "WPThemeCS"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_image_width'] = array(
            'title' => __('Content Image Width', "WPThemeCS"),
            'desc' => __('Width of The Error Image', "WPThemeCS"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_home_redirect'] = array(
            'title' => __('Redirect To Home Page(If Error Page Occurs)', "WPThemeCS"),
            'desc' => __('Redirect to Home Page While Error Occur', "WPThemeCS"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        ...
        $this->settings['ttr_mm_enable'] = array(
            'title' => __('Enable Maintenance Mode', "WPThemeCS"),
            'desc' => __('Enable/Disable Maintenance Mode', "WPThemeCS"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_title'] = array(
            'title' => __('Title for Maintenance Mode Page', "WPThemeCS"),
            'desc' => __('Set the Title', "WPThemeCS"),
            'std' => '',
            'type' => 'text',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_content'] = array(
            'title' => __('Content for Maintenance Mode Page', "WPThemeCS"),
            'desc' => __('Content for Maintenance Mode page', "WPThemeCS"),
            'std' => '',
            'type' => 'textarea',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_image'] = array(
            'title' => __('Background Image for Maintenance Mode', "WPThemeCS"),
            'desc' => __('Select Image for Maintenance Mode Page', "WPThemeCS"),
            'std' => '',
            'type' => 'media',
            'section' => 'maintenance'
        );
        ...
        $this->settings['ttr_googlemap_type'] = array(
            'title' => __('Choose the type of Google Map', "WPThemeCS"),
            'desc' => __('Choose the type of Google Map', "WPThemeCS"),
            'type' => 'select',
            'std' => 'Road',
            'choices' => array(
                'choice1' => __('ROAD', "WPThemeCS"),
                'choice2' => __('SATELLITE', "WPThemeCS"),
                'choice3' => __('HYBRID', "WPThemeCS"),
                'choice4' => __('TERRAIN', "WPThemeCS")),
            'section' => 'googlemap'
        );
       $this->settings['ttr_map_latitude'] = array(
            'title' => __('Set Latitude', "WPThemeCS"),
            'desc' => __('Set Latitude', "WPThemeCS"),
            'std' => '25.306944',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_longitude'] = array(
            'title' => __('Set Longitude', "WPThemeCS"),
            'desc' => __('Set Longitude', "WPThemeCS"),
            'std' => '-257.858333',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_width'] = array(
            'title' => __('Set Width of Map', "WPThemeCS"),
            'desc' => __('Set Width of Map', "WPThemeCS"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_height'] = array(
            'title' => __('Set Height of Map', "WPThemeCS"),
            'desc' => __('Set Height of Map', "WPThemeCS"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_marker_enable'] = array(
            'title' => __('Display Marker', "WPThemeCS"),
            'desc' => __('Enable/Disable the Position Marker', "WPThemeCS"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'googlemap'
        );
        $this->settings['ttr_marker_text'] = array(
            'title' => __('Set Marker Label', "WPThemeCS"),
            'desc' => __('Set Marker Label', "WPThemeCS"),
        ...
        $this->settings['ttr_googlemap_api'] = array(
            'title' => __('Set Google API Key', "WPThemeCS"),
            'desc' => __('Set Google API Key', "WPThemeCS"),
            'std' => '',
            'type' => 'text',
            'patter' => '\d+',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_google_docs_viewer_shortcode'] = array(
            'title' => __('Google Docs Viewer', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_displaying_recent_posts_shortcode'] = array(
            'title' => __('Displaying Related Posts', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
            'std' => '[related_posts]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_google_adsense_shortcode'] = array(
            'title' => __('Google AdSense', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_google_chart_shortcode'] = array(
            'title' => __('Google Chart', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_tweet_me_button_shortcode'] = array(
            'title' => __('Tweet Me Button', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
            'std' => '[tweet]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_private_content_shortcode'] = array(
            'title' => __('Private Content', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
        ...
        /*$this->settings['ttr_contact_us_form_shortcode'] = array(
            'title' => __('Contact Us Form', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
            'std' => '[contact_us_form]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_custommenu_shortcode'] = array(
            'title' => __('Custom Menu', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_comments_shortcode'] = array(
            'title' => __('Recent Comments', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_posts_shortcode'] = array(
            'title' => __('Recent Posts', "WPThemeCS"),
            'desc' => __('To use Copy/Paste the above shortcode', "WPThemeCS"),
            'type' => 'shortcode',
       ...
       ===========================================*/
        ...
        $this->settings['ttr_ftp_server_address'] = array(
            'title' => __('FTP Server Address', "WPThemeCS"),
            'desc' => __('Enter the FTP Address ', "WPThemeCS"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_name'] = array(
            'title' => __('FTP User name', "WPThemeCS"),
            'desc' => __('Enter the FTP username ', "WPThemeCS"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_password'] = array(
            'title' => __('FTP User password', "WPThemeCS"),
            'desc' => __('Enter the FTP password ', "WPThemeCS"),
            'std' => '',
            'type' => 'password',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_recipient_email'] = array(
            'title' => __('Email of recipient', "WPThemeCS"),
            'desc' => __('Enter the name of email recipient ', "WPThemeCS"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_check_connection'] = array(
            'title' => __('Check FTP Connection', "WPThemeCS"),
            'desc' => __('Click to check the FTP Connection Status', "WPThemeCS"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_manual_database_backup'] = array(
            'title' => __('Database Backup (.sql file)', "WPThemeCS"),
            'desc' => __('Add/Remove database (.sql) file to Backup zip', "WPThemeCS"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_recovery_enable'] = array(
            'title' => __('Enable Automatic Backup/Recovery Mode)', "WPThemeCS"),
            'desc' => __('Enable/Disable Automatic Backup/Recovery Mode', "WPThemeCS"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_plugin_backup'] = array(
            'title' => __('Include Plugins', "WPThemeCS"),
            'desc' => __('Include/Exclude plugins to Backup Zip', "WPThemeCS"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_theme_backup'] = array(
            'title' => __('Include Themes', "WPThemeCS"),
            'desc' => __('Include/Exclude themes to Backup Zip', "WPThemeCS"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_uploads_backup'] = array(
            'title' => __('Include Uploads', "WPThemeCS"),
            'desc' => __('Include/Exclude uploads to Backup Zip', "WPThemeCS"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "WPThemeCS"),
            'desc' => __('Set the folder name to take the backup', "WPThemeCS"),
            'std' => 'Backup',
            'type' => 'text',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_interval'] = array(
            'title' => __('Automatic Backup intervals', "WPThemeCS"),
            'desc' => __('Select the database interval to take backup', "WPThemeCS"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('Every 10 mins', "WPThemeCS"),
                'choice2' => __('Every hour', "WPThemeCS"),
                'choice3' => __('Every 4 hours', "WPThemeCS"),
                'choice4' => __('Every 8 hours', "WPThemeCS"),
                'choice2' => __('Every 12 hours', "WPThemeCS"),
                'choice3' => __('Daily', "WPThemeCS"),
                'choice4' => __('Weekly', "WPThemeCS")),
            'section' => 'backup'
        );
        $this->settings['ttr_storage_backup'] = array(
            'title' => __('Choose your Remote Storage', "WPThemeCS"),
            'desc' => __('Set time to the backup', "WPThemeCS"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('FTP', "WPThemeCS"),
                'choice2' => __('Email', "WPThemeCS")),
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "WPThemeCS"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_browse'] = array(
            'title' => __('Select Backup Folder', "WPThemeCS"),
            'desc' => __('Select the folder(.zip file only)', "WPThemeCS"),
            'std' => '',
            'type' => 'file',
            'section' => 'restore'
        );
        $this->settings['ttr_include_database_restore'] = array(
            'title' => __('Restore Database(.sql)', "WPThemeCS"),
            'desc' => __('Enable/Disable to restore databases for Site', "WPThemeCS"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_theme_restore'] = array(
            'title' => __('Restore Themes', "WPThemeCS"),
            'desc' => __('Enable/Disable to restore theme folder for Site', "WPThemeCS"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_plugins_restore'] = array(
            'title' => __('Restore Plugins', "WPThemeCS"),
            'desc' => __('Enable/Disable to restore plugins folder for Site', "WPThemeCS"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_uploads_restore'] = array(
            'title' => __('Restore Uploads', "WPThemeCS"),
            'desc' => __('Enable/Disable to restore uploads folder for Site', "WPThemeCS"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
    ...
    public function scripts()
    {
        ...
        $translations = array_merge(array('tt_xmlerror' => (__('Please, select an xml file','WPThemeCS')), 'tt_savechanges' => (__('No changes to export in Theme Options. Please save your changes properly.','WPThemeCS'))));
    ...
    public function validate_settings($input)
    {
        ...
        foreach ($this->settings as  $key => $value)
        {
 			if($key == 'ttr_designedby_link_url')
            {
               ...
               { 
                 add_settings_error('templatetoaster_theme_options','errorMsg',__("Please enter a valid URL", "WPThemeCS"),'error') ;
			     return $options;
              }             
            }
