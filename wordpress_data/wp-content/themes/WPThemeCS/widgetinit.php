...
'name' => __( 'CAWidgetArea00', 'WPThemeCS' ),
'id' => 'contenttopcolumn1',
'description' => __( 'An optional widget area for your site content', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'CAWidgetArea01', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'CAWidgetArea02', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'CAWidgetArea03', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'HAWidgetArea00', 'WPThemeCS' ),
'id' => 'headerabovecolumn1',
'description' => __( 'An optional widget area for your site header', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar( array(
'name' => __( 'HAWidgetArea01', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'HAWidgetArea02', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'HAWidgetArea03', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'HBWidgetArea00', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'HBWidgetArea01', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'HBWidgetArea02', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'HBWidgetArea03', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'SAWidgetArea00', 'WPThemeCS' ),
'id' => 'slideshowabovecolumn1',
'description' => __( 'An optional widget area for your site slideshow', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar( array(
'name' => __( 'SAWidgetArea01', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'SAWidgetArea02', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'SAWidgetArea03', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'SBWidgetArea00', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'SBWidgetArea01', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'SBWidgetArea02', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'SBWidgetArea03', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'MAWidgetArea00', 'WPThemeCS' ),
'id' => 'menuabovecolumn1',
'description' => __( 'An optional widget area for your site menu', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar( array(
'name' => __( 'MAWidgetArea01', 'WPThemeCS' ),
'id' => 'menuabovecolumn2',
'description' => __( 'An optional widget area for your site menu', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
...
register_sidebar( array(
'name' => __( 'MAWidgetArea02', 'WPThemeCS' ),
'id' => 'menuabovecolumn3',
'description' => __( 'An optional widget area for your site menu', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
...
register_sidebar( array(
'name' => __( 'MAWidgetArea03', 'WPThemeCS' ),
'id' => 'menuabovecolumn4',
'description' => __( 'An optional widget area for your site menu', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
...
register_sidebar( array(
'name' => __( 'MBWidgetArea00', 'WPThemeCS' ),
'id' => 'menubelowcolumn1',
'description' => __( 'An optional widget area for your site menu', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
...
register_sidebar( array(
'name' => __( 'MBWidgetArea01', 'WPThemeCS' ),
'id' => 'menubelowcolumn2',
'description' => __( 'An optional widget area for your site menu', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
...
register_sidebar( array(
'name' => __( 'MBWidgetArea02', 'WPThemeCS' ),
'id' => 'menubelowcolumn3',
'description' => __( 'An optional widget area for your site menu', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
...
register_sidebar( array(
'name' => __( 'MBWidgetArea03', 'WPThemeCS' ),
'id' => 'menubelowcolumn4',
'description' => __( 'An optional widget area for your site menu', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
...
register_sidebar( array(
'name' => __( 'CBWidgetArea00', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'CBWidgetArea01', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'CBWidgetArea02', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'CBWidgetArea03', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FAWidgetArea00', 'WPThemeCS' ),
'id' => 'footerabovecolumn1',
'description' => __( 'An optional widget area for your site footer', 'WPThemeCS' ),
'before_widget' => '<aside id="%1$s" class="widget %2$s">',
'after_widget' => "</aside>~tt",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar( array(
'name' => __( 'FAWidgetArea01', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FAWidgetArea02', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FAWidgetArea03', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FBWidgetArea00', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FBWidgetArea01', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FBWidgetArea02', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FBWidgetArea03', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'first-footer-widget-area', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'second-footer-widget-area', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'third-footer-widget-area', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FooterColumn00', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FooterColumn11', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FooterColumn22', 'WPThemeCS' ),
...
register_sidebar( array(
'name' => __( 'FooterColumn33', 'WPThemeCS' ),
