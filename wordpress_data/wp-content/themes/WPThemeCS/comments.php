...
<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'WPThemeCS' ); ?></p>
</div>
<?php
return;
endif;
...
<?php
printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'WPThemeCS' ),
...
<h1 class="assistive-text"><?php _e( 'Comment navigation', 'WPThemeCS' ); ?></h1>
<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'WPThemeCS' ) ); ?></div>
<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'WPThemeCS' ) ); ?></div>
</nav>
<?php endif;?>
...
<p class="nocomments"><?php _e( 'Comments are closed.', 'WPThemeCS' ); ?></p>
<?php } ?>
<?php endif; ?>
