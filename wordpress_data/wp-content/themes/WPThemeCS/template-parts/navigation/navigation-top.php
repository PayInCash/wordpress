...
<nav class="navbar-default navbar-expand-md navbar" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'WPThemeCS' ); ?>">
...
<a href="#content" class="menu-scroll-down"><span class="screen-reader-text"><?php _e( 'Scroll down to content', 'WPThemeCS' ); ?></span></a>
<?php endif; ?>
</div>
</div>
<div class="margin_collapsetop"></div>
